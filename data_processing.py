...
class comparison:
    def __init__(self, file_name, simulation, plot_iter=0):
...
class minMaxNorm(comparison) :
	def __init__(self,file_name,simulation, plot_iter=0):
		super().__init__(file_name, simulation, plot_iter)
...
class medianFoldNorm(comparison) :
	...
	def get_difference(self, arguments):
		...
		# Normalize both exp- and sim-data by median-fold normalization
