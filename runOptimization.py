...
if __name__ == '__main__':
    ...
    compareDist = medianFoldNorm('Data/polymer_300k.xlsx', polymer)
    # compareDist = translationInvariant('Data/polymer_50k.xlsx', polymer)

    param_boundaries = np.array([[8000, 10000], [90000, 150000], [300000000, 400000000],
    ...
    xp, yp, ybest, model = bayesianOptimisation(n_iters=200, costFunction=compareDist.costFunction, bounds=param_boundaries,
                                         n_params=10,
    ...
    np.save(file='eval_model_MAT_EI_ls_0point1', arr=ybest)
    pickle.dump(model, open("model_MATa_EI_ls_0point1.p", "wb"))
